                        ...
                        <div class="box box-solid">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input  data-field-translator="true" <?= $disabled ?> type="text" class="form-control"
                                                            value="<?= $event['name'] ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea data-field-translator="true" name="editable-textarea" <?= $disabled ?> id="editable-textarea" class="form-control"
